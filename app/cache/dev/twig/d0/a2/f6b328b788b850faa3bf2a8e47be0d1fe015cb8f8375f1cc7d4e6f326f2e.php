...
/* VaeAdminBundle:Inscriptions:index.html.twig */
class __TwigTemplate_d0a2f6b328b788b850faa3bf2a8e47be0d1fe015cb8f8375f1cc7d4e6f326f2e extends Twig_Template
{
    ...
    {
        // line 7
        echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("VaeAdminBundle:Inscriptions:limit", array("page" => (isset($context["page"]) ? $context["page"] : $this->getContext($context, "page")))));
        echo "
";
    }
    ...
    {
        return "VaeAdminBundle:Inscriptions:index.html.twig";
    }
