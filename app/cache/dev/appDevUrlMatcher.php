...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (preg_match('#^/(?P<langue>fr|en)/(?P<nomSite>[^/]++)/(?P<slugRubrique>[^/]++)/(?P<slugFormation>[^/]++)/inscription$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'vae_inscription_formation')), array (  '_controller' => 'Vae\\InscriptionBundle\\Controller\\InscriptionController::listeAction',  'langue' => 'fr',));
        }
        ...
        if (preg_match('#^/(?P<_locale>[^/]++)/(?P<nomSite>[^/]++)/(?P<slugRubrique>[^/]++)$#s', $pathinfo, $matches)) {
