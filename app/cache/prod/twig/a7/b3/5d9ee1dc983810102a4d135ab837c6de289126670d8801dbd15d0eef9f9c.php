...
<head>
    ...
    <!-- Bootstrap -->
        ";
        // line 9
        if (($this->getAttribute((isset($context["site"]) ? $context["site"] : null), "nom") == "Alphabétisation")) {
            // line 10
        ...
        // line 12
        echo "        ";
        if (($this->getAttribute((isset($context["site"]) ? $context["site"] : null), "nom") == "EFT")) {
            // line 13
            echo "        <link rel=\"stylesheet\" href=\"";
        ...
        // line 15
        echo "        ";
        if (($this->getAttribute((isset($context["site"]) ? $context["site"] : null), "nom") == "Céramique")) {
            // line 16
            echo "        <link rel=\"stylesheet\" href=\"";
    ...
    <section class=\"navbar navbar-fixed-top row\" role=\"navigation\">
      <section class=\"container col-md-10 menu-center\" id='menu-center'>
        ...
        if (((isset($context["langue"]) ? $context["langue"] : null) == "fr")) {
            // line 56
            echo "                ";
            echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("VaeBaseBundle:Rubrique:menu", array("nomSite" => $this->getAttribute((isset($context["site"]) ? $context["site"] : null), "nom"), "slugRubrique" => $this->getAttribute((isset($context["rubrique"]) ? $context["rubrique"] : null), "slug"))));
            echo "
            ";
        } else {
            // line 58
            echo "                ";
            echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("VaeBaseBundle:Rubrique:menu", array("nomSite" => $this->getAttribute((isset($context["site"]) ? $context["site"] : null), "nom"), "slugRubrique" => $this->getAttribute((isset($context["rubrique"]) ? $context["rubrique"] : null), "slugEn"))));
            echo "
            ";
        }
        // line 60
     ...
     <section id=\"fondheader\">
        ...
        <article>
         ...
         <a href=\"";
        // line 79
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("vae_base_dons_dons", array("nomSite" => $this->getAttribute((isset($context["site"]) ? $context["site"] : null), "nom"))), "html", null, true);
        echo "\">
             ";
        // line 80
        if (((isset($context["langue"]) ? $context["langue"] : null) == "fr")) {
